...
export default function Question({ id, title }: QuestionProps) {
  return (
    <IonItem routerLink={`/solve/problem/${id}`} detail={false} lines="none" color="none">
      <div className="relative flex flex-col w-full bg-[#F9F5FF] rounded-[5px] px-5 py-4 gap-4 cursor-pointer hover:opacity-70 ">
        <div>
